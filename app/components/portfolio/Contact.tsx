    ...
    <section id="contact" className="relative min-h-screen flex flex-col items-center justify-center px-6 py-32 text-center overflow-hidden">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 mb-14">
        ...
        <button
          ...
          className="font-mono text-[11px] uppercase tracking-[0.18em] font-bold px-7 py-4 rounded-full bg-foreground text-background border-2 border-foreground card-sticker-hover cursor-pointer"
          style={{ boxShadow: "6px 6px 0 0 var(--color-foreground)" }}
        >
          ✉ message me
        </button>
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 font-mono text-xs text-muted-foreground">
        ...
        <button onClick={() => setIsFormOpen(true)} className="hover:text-foreground transition-colors cursor-pointer">
