...
import resumeUrl from "../../assets/MuhammadAsim_Resume.pdf";
        ...
        <div className="relative">
          <div
            ...
            style={{
              ...
              boxShadow: "0 30px 80px -20px oklch(0.18 0.02 280 / 0.45), 0 0 60px oklch(0.78 0.16 215 / 0.18)",
            }}
          >
            {/* traffic dots */}
